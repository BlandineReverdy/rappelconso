...
def normaliser_motif(motif, risque):
    m = str(motif).lower()
    r = str(risque).lower()
    if "salmonella" in m or "salmonelle" in m or "salmon" in r : 
        return "Présence de Salmonelle"
    return "Autre motif"
...
st.title("Focus : :red[Présence de Salmonelle]")
st.divider()
...
with col_gauche:
    ...
    with st.container(border=True):
        ...
        st.info("""
        La salmonellose est une infection causée par des bactéries du genre Salmonella, présentes
        principalement dans les œufs crus ou peu cuits, les viandes, et certains produits laitiers.
        La contamination est souvent liée à une cuisson insuffisante ou à une rupture de la chaîne du froid.
        """)
        
        st.write("""
        **Risques pour la santé :**
        Les symptômes apparaissent généralement rapidement : diarrhées, fièvre, douleurs abdominales, parfois vomissements. 
        L’infection est le plus souvent bénigne mais peut être plus sévère chez les nourrissons, les personnes âgées ou fragiles.
        """)
        ...
        * 😷 Surveiller l'apparition de symptômes pendant les jours suivants
        """)
        ...
        * 🆘 **Numéro d’urgence européen :** 112
        ...
        st.markdown("""
        **Sources :**
        * Institut Pasteur, 2024. Salmonelloses. Date de consultation : 16/04/2026. Disponible sur : <https://www.pasteur.fr/fr/centre-medical/fiches-maladies/salmonellose>.
        """)
...
with col_droite:
    ...
    if not data_rappels.empty:
        ...
        st.info("Aucun rappel récent trouvé pour présence de Salmonelle.")
