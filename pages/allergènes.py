...
# --- 1. CONFIGURATION ---
st.set_page_config(page_title="Fiche Rappel - allergènes", layout="wide")
...
def load_data_by_motif(): 
    ...
    try:
        ...
        # Filtre Motif strict
        cible = "allergènes|allergène|allergene" 
...
def normaliser_motif(motif, risque):
    m = str(motif).lower()
    r = str(risque).lower()
    if "allerge" in m or "a" in m or "allèrg" in r : 
        return "Allergènes non mentionnés"
    return "Autre motif"
...
st.title("Focus : :red[Allergènes non mentionnés]")
st.divider()
...
with col_gauche:
    ...
    with st.container(border=True):
        ...
        st.info("""
        Une allergie est une réaction du système immunitaire à un ou plusieurs allergènes présents dans les aliments. 
        Un allergène est une substance qui déclenche ou favorise une allergie ou une intolérance
        Il existe 14 allergènes à déclaration obligatoire. (gluten, crustacés, oeufs, poissons, arachides, soja, lait, fruits à coques, céleri, moutarde, sésame, sulfites, lupin, mollusques) 
        L'étiquetage des allergènes est cadré par le règlement UE 1169/2011, aussi appelé le règlement INCO.
        """)
        
        st.write("""
        **Risques pour la santé :**
        Il n'y a aucun impact sur le consommateur s'il n'est pas allergique.
        En cas d'allergie, il ne faut pas consommer le produit car il y a un risque de faire 
        une réaction allergique, l'impact varie en fonction de l'allergène, de la dose ingérée 
        et de l'âge.
        """)
        ...
        * 😷 Surveiller les symptômes  (apparition de quelques minutes à 2 heures après ingestion de l'aliment) et ne pas négliger les premiers symptômes. 
        ...
        * 🆘 **Numéro d’urgence européen :** 112
        ...
        st.markdown("""
        **Sources :**
        * Assurance Maladie (Ameli), 2025. Symptômes et diagnostic de l’allergie. Date de consultation : 16/04/2026. Disponible sur : <https://www.ameli.fr/assure/sante/themes/allergie/symptomes-diagnostic>.
        * Direction médicale de Livi, 2024. Allergie alimentaire. Date de consultation : 16/04/2026. Disponible sur : <https://www.livi.fr/sante/allergies/allergie-alimentaire/>.
        * Parlement Européen, Conseil de l’Union Européenne, 2025. Règlement (UE) n o  1169/2011 du Parlement européen et du Conseil du 25 octobre 2011 concernant l’information des consommateurs sur les denrées alimentaires, modifiant les règlements (CE) n o  1924/2006 et (CE) n o  1925/2006 du Parlement européen et du Conseil et abrogeant la directive 87/250/CEE de la Commission, la directive 90/496/CEE du Conseil, la directive 1999/10/CE de la Commission, la directive 2000/13/CE du Parlement européen et du Conseil, les directives 2002/67/CE et 2008/5/CE de la Commission et le règlement (CE) n o  608/2004 de la Commission Texte présentant de l’intérêt pour l’EEE. Date de consultation : 16/04/2026. Disponible sur : <http://data.europa.eu/eli/reg/2011/1169/oj>.
        * Service Public Français, 2025. Quels allergènes doivent être mentionnés sur un produit alimentaire ? Date de consultation : 16/04/2026. Disponible sur : <https://www.service-public.gouv.fr/particuliers/vosdroits/F32192>.
        """)
...
with col_droite:
    ...
    if not data_rappels.empty:
        ...
        st.info("Aucun rappel récent trouvé pour alergènes non mentionnés.")
