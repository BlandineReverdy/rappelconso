...
# --- 1. CONFIGURATION ---
st.set_page_config(page_title="Dashboard plats préparés et snacks", page_icon="🍝", layout="wide")
...
<style>
    ...
    .main-card {
        ...
        height: 350px; /* Fixe la hauteur pour l'alignement */
    }
    .img-container {
        height: 150px;
        display: flex;
...
with col_title_header:
    st.title("🍝 Focus : :red[Plats préparés et snacks]")
...
if not data_fish.empty:
    ...
    with col_graph:
        ...
        with st.expander("🔎 Outils de Filtrage - Affinez votre analyse", expanded=True):
            ...
            with f_col1:
                recherche_texte = st.text_input("Recherche libre (ex: Pizza, Carrefour...)", "")
            ...
            st.markdown(f"""
                <div class="main-card">
                    <div style="display: flex; justify-content: space-between; color: #6b7280; font-size: 0.75rem; font-weight: bold;">
                        ...
                        <span style="color: #f59e0b;">📂 SNACKS</span>
                    </div>
