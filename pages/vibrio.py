...
def normaliser_motif(motif, risque):
    m = str(motif).lower()
    r = str(risque).lower()
    if "vibrio" in m or "vibr" in r : 
        return "Présence de vibrio"
    return "Autre motif"
...
st.title("Focus : :red[Présence de vibrio]")
st.divider()
...
with col_gauche:
    ...
    with st.container(border=True):
        ...
        st.info("""
        Les bactéries du genre Vibrio sont présentes naturellement dans les eaux marines, surtout en milieu chaud. 
        Elles peuvent contaminer les poissons, coquillages et crustacés, notamment lorsqu’ils sont consommés crus 
        ou mal conservés.
        """)
       
        st.write("""
        **Risques pour la santé :**
        L’infection peut provoquer des troubles digestifs (diarrhées, douleurs abdominales, vomissements). 
        Dans certains cas plus rares, notamment chez les personnes fragiles, elle peut entraîner des 
        ...
        * 👨‍⚕️ Consulter sans délai un médecin en cas d'apparition d'infections plus graves 
        """)
        ...
        * 🆘 **Numéro d’urgence européen :** 112
        ...
        st.markdown("""
        **Sources :**
        * Agence de la santé publique du Canada, 2022. Vibriose : Symptômes et traitement. Date de consultation : 16/04/2026. Disponible sur : <https://www.canada.ca/fr/sante-publique/services/intoxication-alimentaire/bacterie-vibrio.html>.
        """)
...
with col_droite:
    ...
    if not data_rappels.empty:
        ...
        st.info("Aucun rappel récent trouvé pour présence de vibrio.")
