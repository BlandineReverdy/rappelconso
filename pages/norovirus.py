...
def normaliser_motif(motif, risque):
    m = str(motif).lower()
    r = str(risque).lower()
    if "noro" in m or "norovirus" in r : 
        return "Présence de norovirus"
    return "Autre motif"
...
st.title("Focus : :red[Présence de norovirus]")
st.divider()
...
with col_gauche:
    ...
    with st.container(border=True):
        ...
        st.info("""
        Le norovirus est virus très résistant transmis par les eaux souillées (rejets urbains) ou par un manipulateur infecté. 
        Les coquillages (huîtres, moules) concentrent le virus en filtrant l'eau.
        """)
        
        st.write("""
        **Risques pour la santé :**
        Les symptômes sont une gastro-entérite aiguë : des vomissements violents (en jet), de la diarrhée, des crampes abdominales. 
        Ces derniers apparaissent 12h à 48h après l'ingestion.
        """)
        ...
        * 🧽 Hygiène des mains stricte pour éviter la contagion. Repos.
        * 🔥 Le virus est détruit par une cuisson à cœur (> 90°C).
        ...
        * 🆘 **Numéro d’urgence européen :** 112
        ...
        st.markdown("""
        **Sources :**
        * ANSES, 2022. Fiche de description de danger biologique transmissible par les aliments : Norovirus.
        """)
...
with col_droite:
    ...
    if not data_rappels.empty:
        ...
        st.info("Aucun rappel récent trouvé pour présence de norovirus.")
