...
def load_data_by_motif(): 
    ...
    try:
        ...
        # Filtre Motif strict
        cible = "fabrication|conception|étanchéité|soudure" 
...
def normaliser_motif(motif, risque):
    m = str(motif).lower()
    r = str(risque).lower()
    if "fabrication" in m or "étanchéité" in m or "conception" in r or "soudure" in r: 
        return "Défaut de fabrication"
    return "Autre motif"
...
st.title("Focus : :red[Défaut de fabrication]")
st.divider()
...
with col_gauche:
    ...
    with st.container(border=True):
        ...
        st.info("""
        Les défauts de fabrication peuvent provoquer des 
        micro-fuites ce qui provoque une mauvaise conservation du produit. Dans ce cas, le stockage ne garanti pas 
        la sécurité alimentaire du produit, il peut y avoir une perte de fraîcheur, une altération du goût et l'apparition 
        de moisissures.
        """)
        
        st.write("""
        **Risques pour la santé :**
        Si l'aliment a été contaminé, le risque est les symptômes peuvent être des nausées, diarrhée 
        ou vomissement ou pour les personnes plus fragiles les conséquences seront plus graves.
        Certaines moisissures peuvent présenter un risque pour la santé et causer une intoxication. 
        """)
        
        st.markdown("""
        **Conduite à tenir :**
        * ✅ En cas de doute sur le produit, ne pas le consommer
        * 🔙 Ramener le produit au point de vente (ou le jeter)
        * 😷 Surveiller les symptômes
        * 👨‍⚕️ Consulter sans délai un médecin en cas d'apparition de symptômes graves
        """)
        ...
        * 🆘 **Numéro d’urgence européen :** 112
        ...
        st.markdown("""
        **Sources :**
        * ANSES, 2025. Les infections, intoxications et maladies d’origine alimentaire | Anses - Agence nationale de sécurité sanitaire de l’alimentation, de l’environnement et du travail. Date de consultation : 16/04/2026. Disponible sur : <https://www.anses.fr/fr/content/dossier/les-infections-intoxications-et-maladies-d-origine-alimentaire>.
        * Côté, D., Bureau, S., Glumineau, B., Jean-Luc, 2025. Moisissures alimentaires: danger ou délice? Date de consultation : 16/04/2026. Disponible sur : <https://revolutionfermentation.com/fra/blogs/divers/moisissure-alimentaire-danger/>.
        * Gouvernement du Grand-Duché de Luxembourg, 2024. Défauts d’étanchéité. Date de consultation : 16/04/2026. Disponible sur : <http://securite-alimentaire.public.lu/fr/danger/fr/leak.html>.
        * Syndicat des Entreprises de Commerce International, des Matériels d’Emballage et de Production, 2025. Sécurité alimentaire : un enjeu stratégique pour l’industrie agroalimentaire | SECIMEP. Date de consultation : 16/04/2026. Disponible sur : <https://www.secimep.com/securite-alimentaire-un-enjeu-strategique-pour-l-industrie-agroalimentaire/>.
        """)
...
with col_droite:
    ...
    if not data_rappels.empty:
        ...
        st.info("Aucun rappel récent trouvé pour défaut de fabrication.")
